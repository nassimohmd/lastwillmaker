    ...
    questions: [
      {
        ...
        text: "How would you like your funeral or memorial to be handled?",
        type: "select",
        options: [
          { value: "religious", label: "Traditional religious ceremony" },
          { value: "simple", label: "Simple cremation or burial without ceremony" },
          { value: "memorial", label: "Memorial gathering with friends and family" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "List your investments (e.g., stocks, mutual funds, bonds)",
        conditional: {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Describe your debts (e.g., home loan, car loan, credit cards)",
        conditional: {
          field: "has_debts",
          value: "yes"
        }
    ...
    questions: [
      {
        ...
        type: "select",
        options: [
          { value: "specify", label: "Yes, and I wish to specify who gets them" },
...
export function generateContent(responses: Record<string, any>): string {
  ...
  if (responses.full_name || responses.fathers_name) {
    ...
    content += "being of sound mind and body, do hereby make, publish, and declare this to be my Last Will and Testament, hereby revoking all wills and codicils previously made by me.\n\n";
  }
  ...
  if (responses.funeral_preference) {
    const preferences: Record<string, string> = {
      religious: "I would like my final rites to be conducted as a traditional religious ceremony, in a way that respects my beliefs and brings comfort to my loved ones.",
      simple: "I would like my final rites to be conducted as a simple cremation or burial without ceremony, in a way that respects my beliefs and brings comfort to my loved ones.",
      memorial: "I would like my final rites to be conducted as a memorial gathering with friends and family, in a way that respects my beliefs and brings comfort to my loved ones.",
      other_decide: "I would like my final rites to be decided by my loved ones, in a way that respects my beliefs and brings comfort to them."
    };
    
    const preference = preferences[responses.funeral_preference as keyof typeof preferences] || "";
  ...
  if (responses.organ_donation) {
    const donations: Record<string, string> = {
      ...
      specific: "I wish for specific organs to be donated after my passing, as a final act of giving.",
      none: "I do not wish to donate my organs after my passing."
    };
    
    const donation = donations[responses.organ_donation as keyof typeof donations] || "";
    content += `1. ${donation}`;
  ...
  if (responses.insurance_policies) {
    ...
    const policy = policies[responses.insurance_policies as keyof typeof policies] || "";
  ...
  if (responses.employment_status) {
    const status: Record<string, string> = {
      full_time: "At the time of writing this, I am employed full-time, and any benefits or dues from my employer should be claimed by my nominee or legal heir.",
      part_time: "At the time of writing this, I am employed part-time or freelance, and any benefits or dues from my employer should be claimed by my nominee or legal heir.",
      unemployed: "At the time of writing this, I am unemployed."
    };
    
    const employmentStatus = status[responses.employment_status as keyof typeof status] || "";
  ...
  if (responses.has_bank_accounts === "yes") {
    content += "1. I have bank accounts that should be accessed and closed, with balances transferred to my nominee or heirs.";
    ...
    content += "1. I do not have any bank accounts that need to be managed or closed.\n\n";
  }
  ...
  if (responses.has_investments === "yes") {
    content += "1. I have made investments in various forms, and I want them to be transferred or liquidated as per the needs of my family.";
  ...
  if (responses.has_debts === "yes") {
    content += "1. I request my family to settle the following obligations, if any, from my estate:";
    ...
    content += "1. I do not have any debts or financial obligations that need to be settled.\n\n";
  }
  ...
  if (responses.has_jewellery) {
    const jewellery: Record<string, string> = {
      specify: "My jewellery and ornamentals should be distributed as specified.",
      family_decide: "My jewellery and ornamentals should be decided by my family.",
      no: "I do not have any jewellery or ornamentals to distribute."
    };
    
    const jewelleryStatus = jewellery[responses.has_jewellery as keyof typeof jewellery] || "";
  ...
  if (responses.has_receivables === "yes") {
    content += "1. If anyone owes me money, I would like my family or executor to recover it, as appropriate.";
    ...
    content += "1. There are no outstanding debts owed to me that need to be recovered.\n\n";
  }
  ...
  if (responses.has_legal_docs === "yes") {
    content += "1. My important documents should be secured and handed over to my legal heir or executor.";
    ...
    content += "1. I do not have any important legal documents to be secured.\n\n";
  }

  content += "This document represents my wishes regarding the distribution of my assets and handling of my affairs. I understand that laws vary by jurisdiction, and I have consulted with legal professionals as necessary.\n\n";
